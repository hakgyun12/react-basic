...
var btnDecrease = document.querySelector('#decrease'); // 액션의 이름을 정의한다. 액션의 이름을 문자열 형태로 주로 대문자 작성

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // 액션 객체를 만드는 액션 생성 함수 생성, 액션 객체는 type 값을 반드시 갖고 있어야 한다.
